      ...
      <div class="d-flex col-lg-6 align-items-center auth-bg px-2 p-lg-5">
        ...
        <div class="col-12 col-sm-8 col-md-6 col-lg-10 px-xl-2 mx-auto">
          ...
          <div class="form-group">
            ...
            <p class="text-center mt-2"><span>Didn&rsquo;t get the code?</span><a href="Javascript:void(0)"
                @click="resendVerify"><span>&nbsp;Resend</span></a><span>&nbsp;or</span><a
                href="mailto:ask@gettonote.com" target="_blank"><span>&nbsp;Email Us</span></a></p>
          </div>
        </div>
        <a href="mailto:"></a>
      </div>
