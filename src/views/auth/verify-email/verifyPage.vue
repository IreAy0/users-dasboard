          ...
          <div class="align-items-center">
            ...
            <div class="brand-logo">
              ...
              <p class="card-text mb-2 text-center">
                We sent a verification code to your email. Enter the code in the
                field below.
              </p>
              <div class="form-group">
                <form class="mt-2" @submit.prevent="handleSubmit">
                  ...
                  <div
                    class="d-flex auth-input-wrapper mt-2 d-flex align-items-center justify-content-between"
                  >
                    <VOtpInput
                      ref="otpInput"
