    ...
    <div class="m-0 bg-white shadow zindex-2 rounded-2 px-xl-3 new-auth-inner">
      <div class="  align-items-center ">
        <div class="col-12 col-sm-8 col-md-6  col-lg-12 mx-auto py-3 px-2 p-xl-3 text-center">
          ...
          <h2 class="card-title text-gray-900 fw-bold mb-1">Password Reset</h2>
          <p class="card-text mb-2">
Please kindly  check your recovery email for further instructions on how  to reset your password  </p>
