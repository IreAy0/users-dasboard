...
const env_variable = process.env.VUE_APP_ENVIRONMENT == 'local' ? process.env.VUE_APP_TONOTE_API_BASE_URL_DEV : process.env.VUE_APP_ENVIRONMENT == 'staging' ? process.env.VUE_APP_TONOTE_API_BASE_URL_STAGING : process.env.VUE_APP_TONOTE_API_BASE_URL_LIVE
