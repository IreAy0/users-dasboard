<template>
  <div class="w-100">
    <div data-aos="zoom-in">
      ...
      <div >
        <div v-show="!isLoading" class="video rounded-circle">
          ...
          <template v-else>
              <Camera class="rounded-circle" :resolution="{ width: 160, height: 200 }" ref="camera" @loading="loading" @started="started"
              @camera-change="cameraChange" autoplay>
            </Camera>
      ...
      <img :src="imgPreview" alt="" class="img-fluid" srcset="">
    ...
    <button  class="btn btn-primary icon my-2" @click="takeSnapshot" :disabled="spinner">
...
const affixSnap = () => {
  const uploadPassport = { append_print_id: printId.value, file: printFile.value };
