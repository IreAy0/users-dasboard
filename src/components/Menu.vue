  ...
  <div class="
    ...
    <div class="main-menu-content pt-2">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class="nav-item">
          <router-link class="d-flex align-items-center" to="/admin/dashboard" exact>
        ...
        <li class="nav-item">
          <a :href="`${getEnv}/?qt=${getToken}`" class="d-flex align-items-center">
            ...
            <span class="menu-title text-truncate" data-i18n="Email">My Documents</span></a>
        </li>
        ...
        <!-- <li class="nav-item">
          <a href="#!" class="d-flex align-items-center">
            ...
            <span class="menu-title text-truncate" data-i18n="Email">My Templates</span>
          </a>
        </li> -->

        <li class="nav-item">
          <router-link to="/admin/requests" class="d-flex align-items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <span class="menu-title text-truncate" data-i18n="Email">My Request</span>
          </router-link>
        </li>
        <li class="nav-item">
          <router-link to="/admin/settings" exact class="d-flex align-items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          ...
          <!-- <a href="/admin/settings"  exact class="d-flex align-items-center">
...
export default {
  ...
  computed: {
    ...
    remainingEnvelops() {
      const number =
        this.getActive?.subscription?.plan?.features?.find((feat) =>
          feat?.name?.includes("Envelops")
        )?.limit_number -
        this.getActive?.subscription?.plan?.features?.find((feat) =>
          feat?.name?.includes("Envelops")
        )?.executed;
...
a.router-link-exact-active {
  background: #003bb3;
  box-shadow: 0 0 10px 1px rgba(110, 138, 244, 0.7);
  color: #fff !important;
  font-weight: 400;
  border-radius: 4px;
}
