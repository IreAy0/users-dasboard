<template>
  <nav
    class="header-navbar navbar  align-items-center floating-nav navbar-light navbar-shadow container-xxl"
  >
      ...
      <ul class="nav navbar-nav align-items-center ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div
            ...
            aria-labelledby="dropdown-users"
          >
            <div style="" class="">
            ...
            <!-- <a class="dropdown-item border-bottom align-items-center d-flex justify-content-between" href="#">
              ...
              <div @click="logout" class="text-center">
                <a class="btn btn-outline-seconday"
                  ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="14"
                    height="14"
