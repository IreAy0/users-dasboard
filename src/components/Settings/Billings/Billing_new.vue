    ...
    <div class="">
      ...
      <div class="row gap-2 mx-0 mt-2">
        <div class="col-4 rounded-2 p-1 border">
          ...
          <p class="text-primary mb-0 h5">10</p>
        </div>
        <div class="col p-1 rounded-2 border">
          <p class="text-black">Payment Owner</p>
          <p class="text-primary mb-0 h5">confidence@gmail.com</p>
        </div>
      </div>
      <hr />
      <h2>Plans & Pricing</h2>
          ...
          <div class="row">
            <!-- <div class="col-lg-4 col-md-12 ">
              <label class="card-label">
                <input type="radio" name="plans" v-model="selected" value="Basic" class="card-input-element d-none" id="demo1">
                <div :style="{border: plan.name === 'Basic' ? '2px solid #003BB3' : plan.name == 'Pro' ? '2px solid #DB922B' : plan.name == 'Business' ? '2px solid black' :  '1px solid #EBE9F1 ' }" class="card shadow-none rounded-2 card1 h-100">
                  <div class="card-body d-flex flex-column justify-content-center">
                    <div class="d-flex mb-1 flex-row justify-content-between align-items-center">
                      <div title="Current Plan" class="rounded-3 text-center px-1 border-none p-50 bg-success  bg-opacity-10 text-success" data-v-735b3461=""> Current Plan</div>
                      <div class="ms-auto"  :class="[selected == 'Basic' ? 'd-block' : 'd-none' ]">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" >
                          <rect width="20" height="20" rx="4" fill="#003BB3"/>
                    ...
                    <h3 class=" text-center text-2xl text-primary ">
                      <span>
                        <svg width="33" height="32" viewBox="0 0 33 32" fill="none" >
                          <g clip-path="url(#clip0_4088_924)">
                          ...
                          <path d="M16.5979 16.0446C15.437 15.9977 14.2787 16.1862 13.1926 16.5986C12.1065 17.0111 11.115 17.639 10.2779 18.4446L10.0557 18.6935V24.3201C10.0591 24.5034 10.0987 24.6842 10.172 24.8522C10.2454 25.0202 10.3511 25.1721 10.4832 25.2992C10.6153 25.4263 10.7711 25.5262 10.9418 25.5931C11.1124 25.66 11.2946 25.6926 11.4779 25.689H21.6912C21.8745 25.6926 22.0567 25.66 22.2273 25.5931C22.398 25.5262 22.5538 25.4263 22.6859 25.2992C22.818 25.1721 22.9237 25.0202 22.9971 24.8522C23.0704 24.6842 23.11 24.5034 23.1134 24.3201V18.7113L22.9001 18.4446C22.0684 17.6365 21.0804 17.0068 19.9967 16.5941C18.913 16.1814 17.7564 15.9944 16.5979 16.0446Z" fill="#003BB3"/>
                          </g>
                          <defs>
                          <clipPath id="clip0_4088_924">
                    ...
                    <div class="d-grid my-3">
                      <button class="btn btn-outline-dark px-0 btn-block py-2 text-3xl font-weight-bolder text-black">FREE
                        <span class="text-md text-secondary">(Single user)</span>
                      </button>

                      <p :class="[selected == 'Basic' ? 'd-block' : 'd-none' ]" class="text-lg text-primary text-center mt-2 mb-0 ">Default Plan</p>
            ...
            <!-- subscriptions?.value?.subcriptions -->
            <div v-for="plan in subcriptions.subcriptions" :key="plan" @click="getPlanId(plan.id)" class="col-lg-4 col-md-12 p-50">
              <label class="card-label">
                <input type="radio" name="plans" v-model="selected" :value="plan.id" class="card-input-element d-none" id="demo1">
                <div :style="{border: single_plan.name  === 'Basic' && selected == plan.id ? '2px solid #003BB3' : single_plan.name == 'Pro' && selected == plan.id ? '2px solid #DB922B' : single_plan.name == 'Business' && selected == plan.id ? '2px solid black' :  '1px solid #EBE9F1 ' }" class="card shadow-none rounded-2 card1 h-100">
                  <div class="card-body p-0 d-flex flex-column justify-content-center">
                    ...
                    <div class="d-flex pt-1 px-1 mb-1 flex-row justify-content-between align-items-center">
                      <!-- <div title="Current Plan" class="rounded-3 text-center px-1 border-none p-50 bg-success  bg-opacity-10 text-success" data-v-735b3461=""> Current Plan</div> -->
                      <div :style="{color: plan.name  == 'Custom' ? '#003BB3' : plan.name == 'Pro'  ? '#DB922B' : plan.name == 'Business'  ? 'black' : '#EBE9F1'}" :class="[selected == plan.id && single_plan.name == 'Pro' ? 'd-block' : selected == plan.id && single_plan.name == 'Business'? 'd-block' : selected == plan.id && single_plan.name == 'Custom' ? 'd-block' : 'd-none', 'ms-auto' ]">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" >
                    ...
                    <h3 :style="{color: plan.name  == 'Custom' ? '#003BB3' : plan.name == 'Pro'  ? '#DB922B' : plan.name == 'Business'  ? 'black' : '#EBE9F1'}" class=" text-center text-2xl ">
                      <span> 
                        <svg v-if="plan.name  == 'Custom'" width="33" height="32" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
