    ...
    <div class="tab-content tab-content col-12 col-md-9 bs-stepper-content">
      ...
      <img v-if="userProfile.image.includes('user')" width="100" :src="userProfile.image" :alt="userProfile.first_name"/>
        ...
        <Form autocomplete="off" @submit="handleSubmit" :validation-schema="simpleSchema" id="account-details-modern"
          ...
          <b-button-group class="mt-2 w-100 justify-content-end">
            <div>
              <button type="button" @click="goPrev" id="nextbtn" class="me-3 rounded-circle p-1  btn btn-outline-secondary  ">
      ...
      <div class="  formstep step0 ">
        <div id="personal-info-modern" class="">
          ...
          <Form  @submit="verifyId" :validation-schema="verificationSchema" class="d-flex gap-lg-2  mb-1 flex-column flex-lg-row">
            <div class="flex-grow-1">
             ...
             <div>
              <div class="mb-1 ">
                ...
                <Field :disabled="validState === true" type="date" name="date_of_birth" id="modern-date_of_birth" class="form-control"
                  aria-label="date_of_birth" v-model="userProfile.dob" />
                  <ErrorMessage name="date_of_birth" class="text-danger " />
              </div>
             </div>
             <div>
              <br />
              <button style="padding: 8px 14px" type="submit" v-show="validState == false"
          ...
          <div v-show="userProfile.identity_type === 'vnin' || profile.identity_type == 'vnin' && validState === false">
